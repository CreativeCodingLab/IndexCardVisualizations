...
(function() {
  var bisect, cell_size, color, columns_container, font_size, fries, go, height, i, keep_fries_keys, keep_match_keys, links, main, margin, matrix, matrix_container, n, pc, rows_container, svg, translate, updateAll, updateColumns, updateFries, updateLinks, updatePc, updateRows, url, width, x, y;
