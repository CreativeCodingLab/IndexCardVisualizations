...
(function() {
  ...
  addButtons = function(container) {
    ...
    return panel_body.append("button").classed("btn btn-default", true).text("FRIES cards with potential conflicts and less than 100 matches.").on("click", function() {
      d3.select(".search-buttons").selectAll("label").classed("active", false);
  ...
  updateAll = function() {
    var _wid, _wid_2, fries_title, matrix_height, matrix_width, pc_title;
