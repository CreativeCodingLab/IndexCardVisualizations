...
(function() {
  var addButtons, arrayToString, bisect, cell_padding, cell_size, cell_spacing, clearText, click, color, columns_container, container, doSearch, existing_oboe, font_size, fries, getDistance, getLinks, getOne, height, i, keep_fries_keys, keep_match_keys, links, margin, matrix_container, matrix_panel, mouseout, mouseover, n, panels, pc, rows_container, score_scale, setHoverData, setText, svg, translate, updateAll, updateColumns, updateRows, vectorDistance, vis_row, width, x, y;
  ...
  updateAll = function() {
    var _wid, _wid_2, fries_title, matrix_height, matrix_width, pc_title, x_domain, y_domain;
